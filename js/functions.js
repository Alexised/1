function triangulo(){
	...
	Pero  nosotros podemos decirle al js donde queremos poner nuestra información, 
	utilizando los id que definimos en el html, en este caso en el html creamos un div con el id respuesta
	(<div id="respuesta"></div>) totalmente vacio, pero que ahí siempre será donde aparecerá 
 la información resultante de lo que estamos consultando. */
